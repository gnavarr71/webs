$(function ($) {
    ...
    var submitBtn = $('#add-student-btn'),
        ...
        firebaseRef = new Firebase("https://menu-45dc2-default-rtdb.firebaseio.com/finde");
    ...
    sgtTableElement.on('click', '.edit-btn', function () {
        ...
        studentFirebaseRef.once('value', function (snapshot) {
            $('#modal-edit-name').val(snapshot.val().finde);
